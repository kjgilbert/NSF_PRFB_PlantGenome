...
This proposal will make use of existing maize and teosinte datasets from multiple sources and only generate simulated datasets.
...
\paragraph{Sequence and Genotype Data}
The population of 70 sequenced teosinte individuals at 25X coverage and 5,000 genotyped progeny are provided from \kjg{need to get details and fill in}
The population of 50 sequenced maize individuals at 25X coverage and 5,000 genotyped progeny are provided from \kjg{need to get details and fill in}
Existing data is also available publicly for $\sim$1500 maize genomes through the HapMap 3 and 4 projects \kjg{cite Panzea?}
...
Phenotypic data for these populations exists from the same sources in all cases. \kjg{not sure if this is true, check that out}
