...
%Previous work, for example, has estimated the demographic effects of domestication \citep{Wright:2005} and identified loci under selection \citep{Hufford:2012dy}. And number of studies have used GWAS to study the architecture of phenotypes of interest in both maize \citep{Wallace:2014} and teosinte \citep{Weber:2009}, allowing us to compare our simulated and theoretical results with empirical estimates for both taxa.
