...
\label{surfing}
%To test this, I will impose identical shifts in selection on a number of different potential genetic architectures and assess each population's response in terms of speed and magnitude of phenotypic change. I hypothesize that architectures containing more loci of small effect may have genetic redundancy that benefit adaptation to new conditions.\jri{what is genetic redundancy?}
...
UCD and UC Irvine both have extensive computing resources for my proposed work with access to dedicated processors and nodes across multiple clusters of large RAM capabilities (see Mentoring Plan), and as described, vast sources of knowledge and experience on the topics I plan to investigate, ensuring the success of this work.% I am excited to join and contribute to such an active and vibrant scientific community.
\vspace{-3ex}
...
The proposed research will have wide-ranging impacts for the scientific and public community. I will ensure that my results are publicly available throughout these projects by maintaining code and scripts online at my GitHub account. This will allow other researchers to access analysis methods or data cleaning tools as well as simulation details and parameters which can provide a building block for further research. I will present findings at international conferences and submit publications to open-access pre-print servers. I will be able to broadcast my work more widely to the public through a strong online presence I maintain on Twitter and \href{http://www.molecularecologist.com/}{The Molecular Ecologist}, a blog I have contributed to in the past. %I will also contact local schools where I can tailor seminars to students of different age ranges and topics of interest. These will range in topic from more general science on the origins of crops and domestic species to more in-depth presentations of my research and evolutionary biology as a field that are appropriate for high school students interested in pursuing further study in biology or the sciences more broadly.
 I will have the opportunity to mentor undergraduates in the lab in computational biology and genomic analyses and further apply my teaching skills by developing teaching modules for a flipped version of the undergraduate genetics class Dr. Ross-Ibarra teaches. Lastly, I will develop workshops for graduate students at the Langebio research center in Irapuato, Mexico on population and quantitative genetics and computational tools. Langebio is home to numerous collaborators to the Ross-Ibarra lab who will benefit from this transfer of knowledge. The impacts of this research on corn as a useful crop species for both food and fuel resources is also of an innate broad impact, as understanding the genetics underlying adaptation will ensure a viable future for crop species in the future. Lastly, this research will contribute greatly to my own career development, improving my knowledge on genomics and working in an economically important species. I will be able to learn these vital tools as well as to teach them to undergraduate students in the lab and into the future as the field of genomics continues to grow.

% The impacts of this research will span both the scientific community and the broader public. The research will be made publicly available at all stages through online reposito- ries of simulation and analysis code as well by public archiving of the data. Additionally, I will make published results available on public pre-print servers, or when possible in open-access journals. I have a strong record of conference attendance that I will maintain in order to present results to the scientific community, and will also use my presence on Twitter and as a contributor to The Molecular Ecologist online blog to more frequently reach both scientific and public audiences. Furthermore, I will mentor undergraduate students in the lab, teaching skills on computational and genomics anal- yses and develop workshops on population and quantitative genetics and computational tools that I will organize to teach for graduate students at the Langebio research center in Irapuato, Mexico that is home to a number of collaborators to the Ross-Ibarra lab. I will also have the opportunity to develop undergraduate teaching modules for a ‘flipped’ version of the genetics class taught by Dr. Ross-Ibarra.
