...
Our current knowledge of the genetic basis of adaptation is surprisingly limited. Virtually everything we know about adaptation comes from population genetic theory focusing on single loci or quantitative genetics theory that evaluates variances and ignores the underlying loci. \jri{stoppign here but i think we redo this paragraph to be about quant gen of adaptaton rather than why qtl/gwas don't work. thoughts?}
for studying the adaptation of quantitative traits  genetic architecture of traits are limiting. Quantitative trait locus (QTL) mapping approaches cannot achieve the resolution required to separate causal loci. While genome-wide-association studies (GWAS) improve resolution but suffer from multiple testing difficulties that lead to failure to detect loci of small effect. Furthermore, it is not well understood which or if there may be a general regime for the genetic architecture of important phenotypic traits. Many common alleles of small effect (the infinitesimal model) is difficult to detect, as just described, but another possibility of many very rare alleles of large effect is also difficult because detection would require sufficient sampling to accumulate enough of these rare variants in the sample \citep{Gibson:2012}. 
...
\jri{cite le corre maybe somewhere? http://www.ncbi.nlm.nih.gov/pubmed/22332667}
I propose four objectives which make use of the extensive knowledge and data available in the maize\//teosinte system in order to answer the question of \textbf{how demography and selection change the genetic architecture of quantitative traits}. Objective \ref{modeling} builds a simulation model fit to empirical estimates of the genetic architecture of phenotypically important traits in the wild ancestor of maize, teosinte. Objective \ref{domestication} then uses simulations of maize domestication and comparisons to empirical data to understand how demography and selection combined effect the genetic architecture of phenotypes in maize.  Objective \ref{validation} empirically tests  predictions made in Objectives \ref{modeling} and \ref{domestication} by comparing the effects of maize and teosinte alleles in a common genetic background in two mapping populations. Finally, Objective \ref{surfing} uses our simulation model to predict changing genetic architecture in maize landraces as they spread across the Americas post-domestication. This research will further our understanding of the impact of demography and selection impacts on phenotypic traits, improving our ability to predict the effects of selection and changing environments as well as to exploit genetic diversity in crops for continued breeding. \jri{needs a better last line}
...
\jri{what about ditching this section and just citing the data management section?}
\kjg{yes, all over this idea!}
