...
\centering
  ...
  \caption{Effect sizes from GWAS analyses in maize, grouped by trait category. Inset shows the largest effects. Ear traits are presumed under selection during maize domestication while the others are not. Figure from \citealt{Brown:2011}.}
  \label{fig:model}
\end{SCfigure}
...
\subsection*{Objective IV: Investigate the impact of various demographic and selective pressures on changing genetics of landraces of maize across the Americas} 
